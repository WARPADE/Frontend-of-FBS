      ...
      <div>
        ...
        >
          ...
          <div className="mask d-flex align-items-center h-100 gradient-custom-3" style={{
            ...
            <div className="container py-5 h-100" style={{ marginLeft: "60%" }}>
              <div className="row d-flex justify-content-center align-items-center h-100">
                <div className="col-14 col-md-8 col-lg-8 col-xl-12">
                  <div className="card" style={{ borderRadius: "1rem", backgroundColor: "#BEE0F1" }}>
                        ...
                        {!this.state.successful && (
                          <div>
                            ...
                            <div className="form-group">
                              <button className="btn btn-primary btn-block" style={{marginLeft:150}}>Sign Up</button>
                            </div>
                          </div>
                        )}
